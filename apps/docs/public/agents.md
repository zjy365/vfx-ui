...
- [Glass Lens](https://vfx-ui.dev/components/glass-lens.md): Floating liquid-glass pill lens over a living color field: cylindrical rim refraction, RGB dispersion, rotating specular sweep.
- [Black Hole](https://vfx-ui.dev/components/black-hole.md): The vgpu optimized-black-hole pipeline as a component: baked null-geodesic G-buffer, HDR bloom, prefiltered lensed star field, Doppler beaming — a verbatim port (MIT, Vercel).
...
- [Light Prism](https://vfx-ui.dev/components/light-prism.md): Frosted glass prism on warm paper with a light beam bending through it — SDF triangle glass, cast shadow, and RGB dispersion (pointer tilt opt-in).
- [Hero Fluid](https://vfx-ui.dev/components/hero-fluid.md): Drop-in hero section: centered headline over a GPU liquid-gradient field with real selectable DOM text, scrim-backed contrast, and a reduced-motion static fallback.
- [Hero Aurora](https://vfx-ui.dev/components/hero-aurora.md): Drop-in hero section: bottom-left copy anchored under full-bleed aurora curtains rendered per-pixel on the GPU.
- [Hero Fiber](https://vfx-ui.dev/components/hero-fiber.md): Drop-in hero section: top-weighted headline over luminous silk fibers streaming through the dark.
- [Hero Globe](https://vfx-ui.dev/components/hero-globe.md): Drop-in split hero: copy on the left, the dot-matrix cobe planet (the globe behind vercel.com) glowing on the right.
- [Hero Mesh](https://vfx-ui.dev/components/hero-mesh.md): Drop-in hero section: centered headline over a slow Voronoi mesh-gradient field — every frame a different poster.
- [Hero Iridescent](https://vfx-ui.dev/components/hero-iridescent.md): Drop-in hero section: left copy over a holographic thin-film sheen — the premium product-launch look, computed per-pixel.
- [Hero Vortex](https://vfx-ui.dev/components/hero-vortex.md): Drop-in hero section: centered headline at the eye of a spiral galaxy with star speckles and trailing arms.
- [Hero Ribbon](https://vfx-ui.dev/components/hero-ribbon.md): Drop-in split hero: copy left, three Gaussian light ribbons sweeping the right over a dot-matrix grid.
- [Hero Particles](https://vfx-ui.dev/components/hero-particles.md): Drop-in hero section: top-weighted headline with a badge row over a drifting GPU particle field.
- [Hero Starfield](https://vfx-ui.dev/components/hero-starfield.md): Drop-in hero section: bottom-left copy under a twinkling hashed star grid with parallax drift.
- [Hero Black Hole](https://vfx-ui.dev/components/hero-black-hole.md): Drop-in hero section: left copy beside a ray-traced accretion disk with relativistic beaming and a lensed star field.
- [Chroma Flow](https://vfx-ui.dev/components/chroma-flow.md): Four-edge liquid color field that floods inward toward the direction the cursor sweeps — fbm-noise bleed boundaries driven by pointer velocity.
- [Hero Chroma](https://vfx-ui.dev/components/hero-chroma.md): Drop-in hero section: bottom-left copy over a four-edge liquid color field that floods toward the cursor's sweep direction.

## Per-component docs (machine-readable)

- https://vfx-ui.dev/components/aurora.md
- https://vfx-ui.dev/components/black-hole.md
- https://vfx-ui.dev/components/chroma-flow.md
...
- https://vfx-ui.dev/components/glass-lens.md
- https://vfx-ui.dev/components/hero-aurora.md
- https://vfx-ui.dev/components/hero-black-hole.md
- https://vfx-ui.dev/components/hero-chroma.md
- https://vfx-ui.dev/components/hero-fiber.md
- https://vfx-ui.dev/components/hero-fluid.md
- https://vfx-ui.dev/components/hero-globe.md
- https://vfx-ui.dev/components/hero-iridescent.md
- https://vfx-ui.dev/components/hero-mesh.md
- https://vfx-ui.dev/components/hero-particles.md
- https://vfx-ui.dev/components/hero-ribbon.md
- https://vfx-ui.dev/components/hero-starfield.md
- https://vfx-ui.dev/components/hero-vortex.md
- https://vfx-ui.dev/components/iridescent.md
- https://vfx-ui.dev/components/light-prism.md
